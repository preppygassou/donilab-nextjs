...
import HubFunnelChart from '@/components/global/hub-funnel-chart'
...
const HubPageId = async ({ params, searchParams }: Props) => {
  let currency = 'USD'
  let sessions
  ...
  const HubDetails = await db.hub.findUnique({
    where: {
      id: params.hubId,
    },
  })
 ...
 /*  if (HubDetails.connectAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: HubDetails.connectAccountId,
    })
      ...
      <div className="relative h-full">
          ...
          <div className="absolute -top-10 -left-10 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50">
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/Hub/${HubDetails.id}/launchpad`}
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <PipelineValue hubId={params.hubId} />
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            <Card className="relative">
              ...
              <CardContent className=" text-sm text-muted-foreground flex flex-col gap-12 justify-between ">
                {/* <HubFunnelChart data={funnelPerformanceMetrics} /> */}
