...
export default function Page() {
  const breadcrumbItems = [
    ...
    { title: 'Modifier', link: '/dashboard/users' }
  ];
  ...
  return (
    <ScrollArea className="h-full">
      ...
      <CardHeader>
        <p className="text-2xl font-semibold text-center">⚙️ Modifier</p>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                      <div className="space-y-0.5">
                        ...
                        <FormDescription>
                        Activer l'authentification à deux facteurs pour ce compte
                        </FormDescription>
                      </div>
                      <FormControl>
                        <Switch
