...
function hubListFRReducer(state = { loading: true,hubsfr: [] }, action) {
  switch (action.type) {
    case HUB_LIST_FR_REQUEST:
      return { loading: true, hubsfr: [] };
    case HUB_LIST_FR_SUCCESS:
      return { loading: false, hubsfr: action.payload };
    case HUB_LIST_FR_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
