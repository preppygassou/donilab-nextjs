...
function SpecifityOfWeb({hub}) {
  ...
  return (
    <SpecifitySection>
      <SpecifityParalaxImgtop src={"/assets/svg/SpecifityTopParalaxeImgTop.svg"} alt=""/>
        <SpecifityParalaxImgbottom src={"/assets/svg/SpecifityTopParalaxeImgFull.svg"} alt=""/>
     <SpecifityHeadContent>
        <SpecifityPisionMissionIcon className="" src={"/assets/svg/specifityicone.svg"} alt="Historic icon" />
      <h1>
